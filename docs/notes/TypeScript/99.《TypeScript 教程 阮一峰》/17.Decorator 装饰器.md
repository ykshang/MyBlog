---
title: 17. Decorator 装饰器
createTime: 2025/05/02 12:40:13
permalink: /notes/TypeScript/wuw4ka1x/
copyright:
  creation: reprint
  license: CC-BY-4.0
...
装饰器完美支持面向切面编程(AOP)，解决了以下横切关注点问题：
...
1. `kind`：字符串，表示所装饰对象的类型，可能取以下的值：`class`、`method`、`accessor`、`getter`、`setter`、`field`。这表示一共有六种类型的装饰器。
