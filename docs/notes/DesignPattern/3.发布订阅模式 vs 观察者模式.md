---
title: 发布订阅模式 vs 观察者模式
createTime: 2025/02/24 21:49:20
permalink: /notes/DesignPattern/bh33fpr1/
---
...
| 角度     | 观察者模式                                             | 发布订阅模式                                                            |
| -------- | ------------------------------------------------------ | ----------------------------------------------------------------------- |
| 耦合度   | 观察者和主题之间是松耦合的，但观察者需要知道主题的存在 | 发布者和订阅者完全解耦，通过事件通道通信，互不知道对方的存在            |
