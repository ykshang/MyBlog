...
**作用**：告诉 Webpack 在哪里输出它创建的 bundles 以及如何命名这些文件。
...
**作用**：让 Webpack 能够处理非 JavaScript 文件。
...
**作用**：设置开发或生产环境，启用相应的内置优化。

**特点**：

- 三种模式：`development`、`production` 或 `none`
- 影响 Webpack 的内置优化策略
- 可以通过 `process.env.NODE_ENV` 访问当前模式
